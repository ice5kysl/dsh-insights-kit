...
async function fetchSelfcheck(dir) {
...
function installedPluginNames(entries) {
  ...
  for (const entry of entries) {
    ...
    if (!name2 || name2.startsWith("@deepseek-ai/")) continue;
    names.add(name2);
  }
  return [...names].sort();
}
...
var PLUGIN_INVENTORY_CONTRIBUTION = {
...
async function mountInventory(remote) {
  try {
...
function AuditSection(props) {
  ...
  (0, import_react.useEffect)(() => {
    let cancelled = false;
    void (async () => {
      const dynamics = await fetchDynamics().then((res) => res.dynamics).catch(() => void 0);
      ...
      try {
        ...
        if (!cancelled) setAudit({ form: "full", rows: rows2, dynamics });
      } catch (error) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontWeight: 700, marginBottom: 6 }, children: L("\u5DF2\u88C5\u63D2\u4EF6\uFF08{n}\uFF09", "Installed plugins ({n})", { n: rows.length }) }),
...
function CheckSection(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    ...
    result.card && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HealthCard, { card: result.card, generatedAt: result.generatedAt })
  ] });
}
...
function ScenariosSection(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, marginBottom: 12 }, children: L("\u6309\u4F7F\u7528\u573A\u666F\u53D1\u73B0\u63D2\u4EF6\uFF08{n} \u4E2A\u573A\u666F\uFF09\uFF1B\u70B9\u4EFB\u610F\u63D2\u4EF6\u8DF3\u5230\u300C\u67E5\u9A8C\u300D\u3002", "Discover plugins by use case ({n} scenarios); click any plugin to jump to Check.", { n: scenarios.length }) }),
    scenarios.map((scenario) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: (scenario.plugins ?? []).map((plugin) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "button",
        {
...
function SelfcheckSection() {
  ...
  const [result, setResult] = (0, import_react.useState)({ state: "idle" });
  const [hint, setHint] = (0, import_react.useState)("");
  function submit() {
    ...
    fetchSelfcheck(dir).then((res) => setResult({ state: "ready", report: res.report })).catch((error) => setResult({ state: "error", error }));
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 8, marginBottom: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: buttonStyle, onClick: submit, disabled: result.state === "loading", children: result.state === "loading" ? L("\u81EA\u68C0\u4E2D\u2026", "Checking\u2026") : L("\u81EA\u68C0", "Self-check") })
    ] }),
    hint && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, color: "#ea580c", marginBottom: 8 }, children: hint }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, marginBottom: 12 }, children: L(
    ...
    result.state === "error" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ErrorNote, { error: result.error }),
    result.report && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SelfcheckCard, { report: result.report })
  ] });
}
function SelfcheckCard({ report }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 14, marginBottom: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GradeBadge, { grade: report.grade, large: true }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { minWidth: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontWeight: 700, fontSize: 15 }, children: [
            report.pkgName ?? L("\uFF08\u672A\u58F0\u660E\u5305\u540D\uFF09", "(no package name)"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: mutedStyle, children: [
            ...
            report.score,
            "/100",
            report.npm && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: 10 }, children: report.npm.error ? L("npm registry \u4E0D\u53EF\u8FBE\uFF08npm \u89C4\u5219\u672A\u8BA1\u5206\uFF09", "npm registry unreachable (npm rules not scored)") : report.npm.published ? `npm latest ${report.npm.latest ?? "?"} \xB7 ${report.npm.versions ?? "?"} ${L("\u4E2A\u7248\u672C", "releases")}` : L("npm \u672A\u53D1\u5E03", "not published to npm") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, wordBreak: "break-all" }, children: report.dir })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { marginBottom: 4, fontWeight: 600, fontSize: 12 }, children: L("\u5FBD\u7AE0 markdown", "Badge markdown") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { style: { display: "block", ...mutedStyle, border: "1px solid var(--border, #e2e5e9)", borderRadius: 6, padding: "6px 8px", wordBreak: "break-all", userSelect: "all" }, children: badgeMarkdown })
    ] }),
    report.drops.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...cardStyle, borderColor: "#16a34a" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#16a34a", fontWeight: 600 }, children: L("\u5168\u90E8\u901A\u8FC7\uFF0C\u65E0\u6263\u5206\u9879", "All checks passed \u2014 no deductions") }) }) : orderedCategories.map((category) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontWeight: 700, marginBottom: 6 }, children: [
        CATEGORY_LABELS[category] ? L(CATEGORY_LABELS[category].zh, CATEGORY_LABELS[category].en) : category,
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { ...mutedStyle, fontWeight: 400, marginLeft: 8 }, children: [
          "\u2212",
          groups.get(category).reduce((acc, d) => acc + { fail: 20, major: 10, warn: 5, minor: 2 }[d.sev], 0)
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: groups.get(category).map((d) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { style: { padding: "3px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "baseline" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: SEV_COLORS[d.sev] ?? "#64748b", fontSize: 11, fontWeight: 700, minWidth: 44, textTransform: "uppercase", flexShrink: 0 }, children: d.sev }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: L(d.label.zh, d.label.en) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { style: { ...mutedStyle, fontSize: 11 }, children: d.code })
        ] }),
        (d.fix.zh || d.fix.en) && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { ...mutedStyle, marginLeft: 52 }, children: [
          L("\u600E\u4E48\u4FEE\uFF1A", "Fix: "),
          L(d.fix.zh, d.fix.en)
        ] })
      ] }, d.code)) })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontWeight: 700, marginBottom: 6 }, children: L("\u53EA\u8BFB\u9762\u5B89\u5168\u626B\u63CF", "Read-only surface scan") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, marginBottom: 6 }, children: L(
        "\u6E90\u7801 {files} \u4E2A \xB7 \u6D88\u6BD2\u5F15\u7528 {san} \u4E2A{danger}",
        "{files} source files \xB7 {san} with sanitization refs{danger}",
        {
          files: scan.srcFiles,
          san: scan.sanitizedRefs,
          danger: scan.dangerouslySetInnerHTML ? L(" \xB7 \u26A0 \u5B58\u5728 dangerouslySetInnerHTML", " \xB7 \u26A0 dangerouslySetInnerHTML present") : ""
        }
      ) }),
      scan.totalHits === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { color: "#16a34a", fontSize: 12 }, children: L("\u672A\u53D1\u73B0\u5199\u76D8 / \u5B50\u8FDB\u7A0B / HTTP \u5199\u52A8\u8BCD", "No fs writes / child processes / HTTP write verbs found") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, marginBottom: 4 }, children: L('{n} \u5904\u547D\u4E2D\uFF08\u5BA3\u79F0"\u53EA\u8BFB"\u7684\u63D2\u4EF6\u9700\u9010\u6761\u89E3\u91CA\uFF09\uFF1A', "{n} hit(s) (plugins claiming read-only must justify each):", { n: scan.totalHits }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: scan.hits.map((hit, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { style: { fontSize: 12, padding: "1px 0" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { children: hit.file }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: mutedStyle, children: [
            " \u2192 ",
            hit.kind,
            "\uFF08",
        ...
        scan.totalHits > scan.hits.length && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: mutedStyle, children: L("\u2026\u7B49\u5171 {n} \u5904", "\u2026{n} in total", { n: scan.totalHits }) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontWeight: 700, marginBottom: 6 }, children: L("\u672C\u5730\u4E0D\u53EF\u5224\u5B9A\u7684\u89C4\u5219\uFF08\u4E0D\u8BA1\u5206\uFF09", "Rules not decidable locally (not scored)") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: report.uncovered.map((u) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { style: { fontSize: 12, padding: "1px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { style: mutedStyle, children: u.code }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: mutedStyle, children: [
          " \u2014 ",
          L(u.reason.zh, u.reason.en)
        ] })
      ] }, u.code)) })
    ] })
  ] });
...
function PanelContent(props) {
  ...
  if (section === "audit") {
    ...
    body = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SelfcheckSection, {});
  }
