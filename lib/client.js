...
function observedFailInstallReason(observed) {
...
function DiscouragedInstallButton({ observed }) {
...
function UpgradeBanner() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...cardStyle, borderLeft: "3px solid #dc2626" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...mutedStyle, color: "#dc2626" }, title: failedNames.join(", "), children: L(
    ...
    scenarios.map((scenario) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: (scenario.plugins ?? []).map((plugin) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          ...
          plugin.pkgName && (scenarioInstallBlocked(plugin.observed) ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DiscouragedInstallButton, { observed: plugin.observed }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InstallActionButton, { pkgName: plugin.pkgName, installed: isInstalled }))
        ] }) }, plugin.full_name);
      }) })
    ] }, scenario.id))
  ] });
