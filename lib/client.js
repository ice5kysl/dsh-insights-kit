...
var SITE_UTM = "utm_source=dsh-insights-kit&utm_medium=dsh-plugin";
function tagSiteUrl(url) {
...
var mutedStyle = { color: "var(--dsw-alias-label-secondary, var(--fg-muted, #6a737d)", fontSize: 12 };
...
function DistTags({ tags }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 }, children: Object.entries(tags).map(([tag, version]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { ...mutedStyle, border: "1px solid var(--dsw-alias-border-l2, var(--border, #e2e5e9)", borderRadius: 6, padding: "2px 8px" }, children: [
    tag,
    ": ",
  ...
  if (audit.form === "degraded") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: releases.slice(0, 5).map((rel) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { style: { padding: "4px 0", borderTop: "1px solid var(--dsw-alias-border-l2, var(--border, #eef1f4)" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { style: { fontWeight: 700 }, children: rel.name ?? rel.tag }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { style: { margin: 0, paddingLeft: 0, listStyle: "none" }, children: rows.map((row) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { style: { padding: "4px 0" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
            ...
            low && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: tagSiteUrl(`${SITE}/p/${owner}/${repo}/`), target: "_blank", rel: "noreferrer", style: { color: "#2563eb", fontSize: 12 }, children: L("\u540C\u7C7B\u66F4\u4F18\u66FF\u4EE3 \u2197", "better alternatives \u2197") }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(InstallActionButton, { pkgName: row.name, installed: true, profile })
          ] }),
...
function HealthCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cardStyle, children: [
    ...
    dims.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 8, marginBottom: 10 }, children: dims.map(([dim, value]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { height: 6, borderRadius: 3, background: "var(--dsw-alias-border-l2, var(--border, #e2e5e9)", overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: `${Math.max(0, Math.min(100, value))}%`, height: "100%", background: value >= 90 ? "#16a34a" : value >= 60 ? "#2563eb" : "#ea580c" } }) })
    ] }, dim)) }),
    ...
    similar && similar.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { marginTop: 12, borderTop: "1px solid var(--dsw-alias-border-l2, var(--border, #eef1f4)", paddingTop: 10 }, children: [
...
function inheritThemeTokens(root) {
  ...
  for (const name2 of THEME_TOKENS) {
    const value = computed.getPropertyValue(name2).trim();
    if (value) root.style.setProperty(name2, value);
  }
}
function InsightsPanel() {
  ...
  if (!open) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: backdropStyle, onClick: () => setOpen(false), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: drawerRef, style: drawerStyle, onClick: (event) => event.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PanelContent, { onClose: () => setOpen(false) }) }) });
}
function PanelContent(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: headerStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: tagSiteUrl(SITE), target: "_blank", rel: "noreferrer", style: { ...mutedStyle, color: "#2563eb" }, children: "dsh-insights.com \u2197" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
