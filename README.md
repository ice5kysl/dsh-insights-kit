...
- **Upstream**: `https://dsh-insights.com/data/{insights,scenarios,dynamics,compat}.json` — fetched lazily on first request, cached in memory with a **6-hour TTL**; failed fetches return **502 + JSON error** and never poison the cache.
